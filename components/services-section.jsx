  ...
  const services = [
    {
      ...
      features: ["Responsive Design", "Custom Development", "Performance Optimization","Future-Ready","Clean"],
    },
    {
      icon: ShoppingCart,
      ...
      features: ["Payment Integration", "Inventory Management", "User Experience Design","Secure","Easy Management"],
    },
    {
      icon: Layers,
      title: "Static Website Development",
      description: "Perfect for portfolios, small businesses, or informational pages that don’t require frequent updates.",
      features: ["Cost-Effective", "SEO-Friendly", "Responsive","Low-Maintenance","Clean Design"],
    },
    {
      icon: Wordpress,
      title: "Dynamic Website",
      description: "Websites that update with content from databases or CMS platforms like WordPress.",
      features: ["CMS-Integrated","User Login","SEO-Ready","Modular","Editable Content"],
    },
    {
      icon: TrendingUp,
      ...
      features: ["Fully Customized","Scalable","Unique Design","Conversion-Focused","Interactive"],
    },
  ]
